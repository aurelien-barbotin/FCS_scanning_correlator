...
class bleachCorr(QMainWindow):
    ...
    def plotData(self):
        ...
        totalFn = np.sum(self.objId.CH0, 1).astype(np.float64)
        #Plot 1 in 10 pixels from the Gasussian.
        self.plt1.plot(list(range(0,totalFn.shape[0],10)) ,totalFn[0::10],'blue')
        #If plotting with correction:
        if self.corrFn == True:
            ...
            self.plt1.plot(list(range(0,out_total_fn.shape[0],10)) ,out_total_fn[0::10], 'green')
            self.plt1.plot(list(range(0,out_total_fn.shape[0],10)) ,self.weightings[0::10], 'red')
        ...
        if self.objId.numOfCH == 2:
            ...
            totalFn = np.sum(self.objId.CH1, 1).astype(np.float64)
            #Plot 1 in 10 pixels from the Gasussian.
            self.plt2.plot(list(range(0,totalFn.shape[0],10)) ,totalFn[0::10],'grey')
            #If plotting with correction:
            if self.corrFn == True:
                ...
                self.plt2.plot(list(range(0,out_total_fn.shape[0],10)) ,out_total_fn[0::10], 'green')
                self.plt2.plot(list(range(0,out_total_fn.shape[0],10)) ,self.weightings[0::10], 'red')
...
class SpotSizeCalculation(QMainWindow):
    ...
    def plotData(self):
        ...
        if self.corrFn == True:
            ...
            self.plt1.plot(list(range(0,out_total_fn.shape[0],10)) ,out_total_fn[0::10], 'green',linewidth=1.0)
            self.plt1.plot(list(range(0,out_total_fn.shape[0],10)) ,self.weightings[0::10], 'red',linewidth=1.0)
        ...
        if self.objId.numOfCH == 2:
            ...
            if self.corrFn == True:
                ...
                self.plt2.plot(list(range(0,out_total_fn.shape[0],10)) ,out_total_fn[0::10], 'green',linewidth=1.0)
                self.plt2.plot(list(range(0,out_total_fn.shape[0],10)) ,self.weightings[0::10], 'red',linewidth=1.0)
